...
# example: http://api.socialize.com/0.1/context/37.797476,-122.424082.json
...
class ContextTest(unittest.TestCase):
    ...
    def test_get_context(self):
        ...
        self.assertEqual(mockhttp.method_calls[0][1][0], 'http://api.appmakr.com:80/%s/context/%s,%s.json' % (API_VERSION, self.query_lat, self.query_lon))
