...
from socialize import Client
from models import Feature
from util import APIError, DecodeError, is_valid_lat, is_valid_lon, is_valid_ip, to_unicode
...
class ClientTest(unittest.TestCase):
    ...
    def test_get_feature_useful_validation_error_message(self):
        ...
        try:
            ...
            self.failUnless(str(e).startswith('socializehandle is required to match '), str(e))
        else:
    ...
    def test_get_point_feature(self):
        ...
        self.assertEqual(mockhttp.method_calls[0][1][0], 'http://api.appmakr.com:80/%s/features/%s.json' % (API_VERSION, "SG_4bgzicKFmP89tQFGLGZYy0_34.714646_-86.584970"))
...
EXAMPLE_POINT_BODY="""
{"geometry":{"type":"Point","coordinates":[-105.048054,40.005274]},"type":"Feature","id":"SG_6sRJczWZHdzNj4qSeRzpzz_40.005274_-105.048054@1291669259","properties":{"province":"CO","city":"Erie","name":"CMD Colorado Inc","tags":["sandwich"],"country":"US","phone":"+1 303 664 9448","address":"305 Baron Ct","owner":"socialize","classifiers":[{"category":"Restaurants","type":"Food & Drink","subcategory":""}],"postcode":"80516"}}
"""
...
class TestAnnotations(unittest.TestCase):
    ...
    def test_get_annotations(self):
        ...
        self.assertEqual(mockhttp.method_calls[0][0], 'request')
        self.assertEqual(mockhttp.method_calls[0][1][0], 'http://api.appmakr.com:80/%s/features/%s/annotations.json' % (API_VERSION, self.handle))
        self.assertEqual(mockhttp.method_calls[0][1][1], 'GET')
    ...
    def test_get_annotations_bad_handle(self):
        try:
            ...
            self.failUnless(str(e).startswith('socializehandle is required to match the regex'))
        else:
            self.fail('Should have raised exception.')
